...
Is a very simple Spark Web application, built with Gradle bullabullableble
...
1. Fork the calcApi repository: [github.com/Thorarinn16/stringCalcWeb](https://github.com/Thorarinn16/stringCalcWeb)
